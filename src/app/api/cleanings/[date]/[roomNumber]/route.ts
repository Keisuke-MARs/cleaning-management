...
export async function GET(
    ...
    try {
        ...
        const result = await query<Cleaning>("SELECT * FROM cleanings WHERE cleaning_date = $1 AND room_number = $2", [
            date,
            roomNumber,
        ])
...
export async function DELETE(
    ...
    try {
        ...
        const result = await query("DELETE FROM cleanings WHERE cleaning_date = $1 AND room_number = $2", [
            date,
            roomNumber,
        ])
